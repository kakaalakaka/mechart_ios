...
namespace MeLib
{
	...
	public:
		...
		CPlotMe* GetMovingPlot();
		CBaseShapeMe* GetMovingShape();
	...
	public:
        ...
        //TODO
		//virtual double DivAaxOrMin(int index, CDivMe *div, int flag);
		...
		virtual double GetNumberValue(CDivMe *div, const POINT& mp, AttachVScale attachVScale);
