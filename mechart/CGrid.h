...
namespace MeLib
{
    ...
    protected:
        ...
        void CallCellMouseEvents(int eventID, CGridCellMe *cell, const POINT& mp, MouseButtonsA button, int clicks, int delta);
    ...
    public:
        ...
        CGridColumnMe* GetColumn(const String& columnName);
        ...
        virtual void OnCellClick(CGridCellMe *cell, const POINT& mp, MouseButtonsA button, int clicks, int delta);
        ...
        virtual void OnCellMouseEnter(CGridCellMe *cell, const POINT& mp, MouseButtonsA button, int clicks, int delta);
        virtual void OnCellMouseLeave(CGridCellMe *cell, const POINT& mp, MouseButtonsA button, int clicks, int delta);
